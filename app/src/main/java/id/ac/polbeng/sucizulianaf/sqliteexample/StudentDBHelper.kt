package id.ac.polbeng.sucizulianaf.sqliteexample
...
// If you change the database schema, you must increment the database version.
        ...
        private const val SQL_CREATE_ENTRIES =
            "CREATE TABLE " + DBContract.UserEntry.TABLE_NAME + " (" +
                    DBContract.UserEntry.COLUMN_NIM + " TEXT PRIMARY KEY," + DBContract.UserEntry.COLUMN_NAME + " TEXT," + DBContract.UserEntry.COLUMN_AGE + " TEXT)"
